...
class UserEntity extends StytchEntityBase {
  ...
  /**
   * @param {UserRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<User>}
   */
