...
// Stytch SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class StytchMakeRequest
{
    public static function call(StytchContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new StytchResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new StytchResponse($fetched);
        } else {
