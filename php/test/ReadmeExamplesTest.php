...
// Stytch SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StytchSDK::test)
...
{
    private const SDK_CLASS = 'StytchSDK';
    ...
    private const SDK_BASE = 'stytch_sdk';
