...
require_once __DIR__ . '/../stytch_sdk.php';
...
{
    private static function utility(): StytchUtility
    {
        return new StytchUtility();
    }
    ...
    private static function ctx(array $over = []): StytchContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new StytchContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new StytchOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof StytchError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new StytchOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = StytchMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new StytchOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = StytchMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new StytchOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = StytchMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StytchSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = StytchMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new StytchResponse([]),
            'result' => new StytchResult([]),
        ]);
        [, $err] = StytchMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new StytchSpec(['step' => 's']),
            'response' => new StytchResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new StytchResult([]),
        ]);
        [, $err] = StytchMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new StytchSpec(['step' => 's']),
            'response' => new StytchResponse(self::resp(200, ['v' => 1])),
            'result' => new StytchResult([]),
        ]);
        [, $err] = StytchMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new StytchSpec(['step' => 's']),
            'response' => new StytchResponse(self::resp(200, ['v' => 2])),
            'result' => new StytchResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        StytchMakeResponse::call($ctx);
    ...
    {
        $preset = new StytchResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new StytchSpec([]),
            'response' => new StytchResponse([]),
            'result' => new StytchResult([]),
        ...
        [$got, $err] = StytchMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new StytchResult([])]);
        [, $err] = StytchMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new StytchSpec([]), 'result' => null]);
        [, $err] = StytchMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StytchSpec(['step' => 's']),
            'result' => new StytchResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new StytchOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StytchMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StytchSpec(['step' => 's']),
            'result' => new StytchResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new StytchOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StytchMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StytchResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new StytchSpec([]),
            'result' => new StytchResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = StytchMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StytchMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new StytchError('boom', 'boom');
        $utility->fetcher = function (StytchContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StytchSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = StytchMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (StytchContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = StytchMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(StytchResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (StytchContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StytchSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = StytchMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new StytchResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new StytchSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = StytchMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = StytchMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = StytchMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new StytchResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, StytchDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new StytchResult(['ok' => false])]);
        $this->expectException(StytchError::class);
        StytchDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new StytchResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', StytchMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new StytchBaseFeature();
        $b = new StytchBaseFeature();
        StytchFeatureAdd::call($ctx, $a);
        StytchFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): StytchBaseFeature
    {
        $f = new StytchBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        StytchFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): StytchContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new StytchSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StytchPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new StytchResponse(['headers' => null]),
            'result' => new StytchResult([]),
        ]);
        StytchResultHeaders::call($ctx);
