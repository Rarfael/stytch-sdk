...
// Stytch SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class StytchTestFeature extends StytchBaseFeature
{
    ...
    public function init(StytchContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (StytchContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (StytchContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(StytchContext $ctx, $op, $args): array
    {
