...
type Args struct {
	Entity string         `json:"entity" jsonschema:"user"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.StytchSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "stytch_list",
		Description: "List records from Stytch. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "stytch_load",
		Description: "Load a single record from Stytch. " +
...
func runOp(client *sdk.StytchSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.StytchSDK, name string) (sdk.StytchEntity, error) {
