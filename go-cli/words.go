...
func registerSDKWords(r *eng.Registry, client *sdk.StytchSDK) {
...
func runOp(client *sdk.StytchSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
