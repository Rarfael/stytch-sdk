...
import (
	...
	vs "github.com/voxgig-sdk/stytch-sdk/go/utility/struct"
)

type UserEntity struct {
	name    string
	client  *core.StytchSDK
...
func NewUserEntity(client *core.StytchSDK, entopts map[string]any) *UserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserEntity) GetName() string { return e.name }
...
func (e *UserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserEntity) Deleted() bool {
	return e.deleted
}


func (e *UserEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserEntity(e.client, opts)
}

func (e *UserEntity) Data(args ...any) any {
...
func (e *UserEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *UserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserLoadMatch and returns an User. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UserEntity) LoadTyped(reqmatch UserLoadMatch, ctrl map[string]any) (User, error) {
...
func (e *UserEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *UserEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *UserEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// UserUpdateData and returns an User. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *UserEntity) UpdateTyped(reqdata UserUpdateData, ctrl map[string]any) (User, error) {
...
func (e *UserEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// UserRemoveMatch and returns an User. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *UserEntity) RemoveTyped(reqmatch UserRemoveMatch, ctrl map[string]any) (User, error) {
...
func (e *UserEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
