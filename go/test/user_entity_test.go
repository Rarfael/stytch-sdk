...
func TestUserEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		_, userRef01ListRt0Ok := userRef01ListRt0Result.([]any)
...
func userBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("STYTCH_TEST_USER_ENTID")
	...
	idmapResolved := core.ToMapAny(env["STYTCH_TEST_USER_ENTID"])
	...
	if env["STYTCH_TEST_LIVE"] == "TRUE" {
		...
		client = sdk.NewStytchSDK(core.ToMapAny(mergedOpts))
	}
