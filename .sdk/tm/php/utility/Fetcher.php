...
class StytchFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StytchSDK/1.0)';
    ...
    public static function call(StytchContext $ctx, string $fullurl, array $fetchdef): array
    {
