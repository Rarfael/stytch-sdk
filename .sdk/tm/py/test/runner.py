...
class StytchTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StytchTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = StytchTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = StytchTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
