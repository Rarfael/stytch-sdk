...
(0, node_test_1.describe)('UserEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.StytchSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != user_ref01_data);
        // LIST
        ...
        (0, node_assert_1.default)(null != user_ref01_resdata_up0);
...
function basicSetup(extra) {
    ...
    let client = __1.StytchSDK.test(options, extra);
    ...
    if (live) {
        client = new __1.StytchSDK(merge([
            {
