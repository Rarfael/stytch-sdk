...
(0, node_test_1.describe)('UserDirect', async () => {
    // Per-test live pacing. Delay is read from sdk-test-control.json's
    // `test.live.delayMs`; only sleeps when STYTCH_TEST_LIVE=TRUE.
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('STYTCH_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.StytchSDK({
    ...
    (0, node_test_1.test)('direct-load-user', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-user', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        const client = new __1.StytchSDK({
            apikey: env.STYTCH_APIKEY,
        });
        let idmap = env['STYTCH_TEST_USER_ENTID'];
...
//# sourceMappingURL=UserDirect.test.js.map