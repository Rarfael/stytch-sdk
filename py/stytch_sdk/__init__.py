...
from stytch_sdk.utility import register

# Load features
from stytch_sdk.feature.base_feature import StytchBaseFeature
from stytch_sdk.features import _has_feature, _make_feature
...
class StytchSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = StytchUtility()
        self._utility = utility

        from stytch_sdk.config import shared_config
    ...
    def get_utility(self):
        return StytchUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("StytchSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def User(self, data=None) -> "UserEntity":
        ...
        from stytch_sdk.entity.user_entity import UserEntity
        return UserEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "StytchSDK":
        if sdkopts is None:
            sdkopts = {}
