...
from stytch_sdk.core.control import StytchControl
...
from stytch_sdk.core.helpers import get_ctx_prop, to_map
...
class StytchContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, StytchResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return StytchError(code, msg, self)
