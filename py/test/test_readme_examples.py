# Stytch SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StytchSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StytchSDK(...) and StytchSDK.test(...) become
#      StytchSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "stytch_sdk"
_SDK_CLASS = "StytchSDK"
