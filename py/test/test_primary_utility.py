# Stytch SDK primary utility test
...
from stytch_sdk.utility.voxgig_struct import voxgig_struct as vs
from stytch_sdk import StytchSDK
from stytch_sdk.core.spec import StytchSpec
from stytch_sdk.core.result import StytchResult
from stytch_sdk.core.response import StytchResponse
from stytch_sdk.core.operation import StytchOperation
from stytch_sdk.core.error import StytchError
from stytch_sdk.core import helpers
from stytch_sdk.feature.base_feature import StytchBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = StytchSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = StytchSDK.test(None, None)
        ...
        class TestInitFeature(StytchBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(StytchBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = StytchSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = StytchSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = StytchSDK.test(None, setup_opts)
